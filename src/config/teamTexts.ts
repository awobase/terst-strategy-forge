/** Données texte équipe — sans imports d’images (utilisable côté serveur Node). */
...
export const TEAM_MEMBERS_TEXT: TeamMemberText[] = [
  {
    id: "youri",
    firstName: "Youri",
    lastName: "AUGUIAC",
    ...
    linkedin: "https://www.linkedin.com/company/cayribepartners?originalSubdomain=gp",
